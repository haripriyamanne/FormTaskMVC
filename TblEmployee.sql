...
(    
	...
	@ServiceAreas varchar(50),
	@ImportantAreas varchar(50),
	@WebsiteExample varchar(50) 
)    
as     
Begin     
    Insert into TblEmployee (FirstName,LastName,Email,PhoneNumber,Gender,CompanyName,CompanyType,CompanyLimited,CompanyWebsite,Busineess,Benifits,ListProducts,
	TrustElements,ServiceAreas,ImportantAreas,WebsiteExample ) 
